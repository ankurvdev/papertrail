...
function(use_cpphttplib target)
	...
	find_path(CPPHTTPLIB_INCLUDE_DIRS httplib.h)
...
function(use_tinyxml2 target)
	vcpkg_download(tinyxml2)
	find_package(tinyxml2 CONFIG REQUIRED)
	set_target_properties(tinyxml2::tinyxml2 PROPERTIES MAP_IMPORTED_CONFIG_RELWITHDEBINFO RELEASE)
...
function(use_libssh2 target)
	...
	set_target_properties(Libssh2::libssh2 PROPERTIES MAP_IMPORTED_CONFIG_RELWITHDEBINFO RELEASE)
	target_link_libraries(${target} PRIVATE Libssh2::libssh2)
endfunction()

function(use_dtl target)
	vcpkg_download(dtl)
	find_path(DTL_INCLUDE_DIRS dtl.hpp)
